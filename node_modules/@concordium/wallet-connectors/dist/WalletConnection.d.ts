...
import { AccountTransactionSignature, AccountTransactionType, CredentialStatements, SchemaVersion, VerifiablePresentation } from '@concordium/web-sdk';
 ...
 */
export declare function moduleSchemaFromBase64(schemaBase64: string, version?: SchemaVersion): ModuleSchema;
/**
 * {@link Schema} constructor for a module schema.
 * @param schema The raw module schema in binary.
 * @param version The schema spec version. Omit if the version is embedded into the schema.
 */
export declare function moduleSchema(schema: Buffer, version?: SchemaVersion): ModuleSchema;
/**
 * {@link Schema} constructor for a type schema.
 * @param schemaBase64 The raw parameter schema in base64 encoding.
 * @throws Error if {@link schemaBase64} is not valid base64.
 */
export declare function typeSchemaFromBase64(schemaBase64: string): TypeSchema;
/**
 * {@link Schema} constructor for a type schema.
 * @param schema The raw parameter schema in binary.
 */
export declare function typeSchema(schema: Buffer): TypeSchema;
export declare function schemaAsBuffer(schemaBase64: string): Buffer;
 ...
 */
export declare function stringMessage(msg: string): StringMessage;
/**
 ...
 */
export declare function binaryMessageFromHex(msgHex: string, schema: TypeSchema): BinaryMessage;
/**
